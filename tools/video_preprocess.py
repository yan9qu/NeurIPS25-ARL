...
class VideoFeature:
    ...
    def _init_detection_model(self, args):
        device1 = f'cuda:{args.gpu_id}' if torch.cuda.is_available() else 'cpu'
        model = init_detector(args.detection_config_path, args.detection_checkpoint_path, device=device1)
